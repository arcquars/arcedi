		...
		<div class="panel-body">
				...
				<table class="reset_table table_arcedu">
					...
					<tr>
						<td>
							...
							<p class="arcedi_p_title">Contrato: <span class="arcedi_p"><?php echo $dataEnv->contract_id; ?></span> <span>Hambiente: </span><span class="arcedi_p"><?php echo $dataEnv->code; ?></span></p>
							<p></p>
						</td>
						<td style="text-align: right;">
							<p class="arcedi_p_title">Fecha Pago: <span class="arcedi_p"><?php echo $paymentA->payment_date; ?></span></p>
			...
			<table class="reset_table table_arcedu" style="width: 100%;">
				...
				<tr class="arcedi_p">
					...
					<td>Pago despensas de <?php echo $paymentA->month_total; ?> meses (<?php echo $paymentA->date_start; ?> al <?php echo $paymentA->date_end; ?>)</td>
					<td style="text-align: right;"><?php echo $paymentA->payment_larder; ?></td>
				</tr>
				<?php $penalty_fee = floatval($paymentA->penalty_fee); ?>
				<?php if($penalty_fee > 0){  ?>
				<tr class="arcedi_p">
					<td style="text-align: center;">1</td>
					<td>Multa por mora <?php echo "( Multa: ".$paymentA->penalty_fee." Bs. por ".$paymentA->penalty_day." dias) "; ?></td>
					<td style="text-align: right;"><?php echo sprintf("%0.2f",$paymentA->penalty_fee*$paymentA->penalty_day); ?></td>
				</tr>
				<?php }?>
				<tr class="arcedi_p">
			...
			<table style="width: 100%;">
				...
				<tr>
					...
					<td style="text-align: right; width: 25%;"><p class="arcedi_p_title">Total: <span><?php echo $paymentA->total; ?></span> Bs.</p></td>
				</tr>
			</table>
			<div style="height: 20px;"></div>
		</div>
