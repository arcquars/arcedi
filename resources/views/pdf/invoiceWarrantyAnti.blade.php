...
$is_ok = ($FmyFunctions1->numtoletras($rentalAnti->anticretico));
?>
        <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="panel-body">
      ...
      <table class="reset_table table_arcedu">
        ...
        <tr>
          <td>
            ...
            <p class="arcedi_p_title">Contrato: <span class="arcedi_p">{{ $rentalAnti->contract_id }}</span></p>
            <p></p>
          </td>
          <td style="text-align: right;">
            <p class="arcedi_p_title">Fecha Pago: <span class="arcedi_p" style="font-size: 10px;">{{ $rentalAnti->date_payment_warranty }}</span></p>
    ...
    <table class="reset_table table_arcedu" style="width: 100%;">
      ...
      <tr class="arcedi_p">
        ...
        <td><p class="arcedi_p">Pago del contrato de anticretico</p></td>
        <td style="text-align: right;">
        {{ $rentalAnti->anticretico }}
        </td>
      </tr>
    ...
    <table style="width: 100%;">
      ...
      <tr>
        ...
        <td style="text-align: right; width: 25%;"><p class="arcedi_p_title">Total: <span><?php echo $rentalAnti->anticretico; ?></span> Bs.</p></td>
      </tr>
    </table>
    <div style="height: 20px;"></div>
  </div>
