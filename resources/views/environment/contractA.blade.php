        ...
        <div class="col-md-9" style="padding-left: 2px;">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h4 style="color: #474B03;">Historial contrato Anticrisis</h4>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td><h5 class="h5_arcedi"><b>Fecha Inicio Contrato: </b>{!! $rental_a->date_admission !!}</h5></td>
                            <td style="text-align: right;"><h5 class="h5_arcedi"><b>Fin Contrato: </b>{!! $rental_a->date_end !!}</h5></td>
