  ...
  <div class="col-md-9" style="padding-left: 2px;">
    <div class="panel panel-default">
      <div class="panel-body">
          ...
          <br>
          <form method="post" id="fBuyProduct">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="row">
                  <div class="col-md-3" style="text-align: right;"><label for="iProvider">Proveedor:</label></div>
                  <div class="col-md-3"><input class="form-control" type="text" id="iProvider" name="nProvider" ></div>
                  <div class="col-md-3" style="text-align: right;"><label for="iNit">Nit:</label></div>
                  <div class="col-md-3"><input class="form-control" id="iNit" type="number" ></div>
              </div>
              <div class="row">
                  <div class="col-md-3" style="text-align: right;"><label for="iDoc"># doc:</label></div>
                  <div class="col-md-3"><input class="form-control" id="iDoc" type="text" ></div>
                  <div class="col-md-3" style="text-align: right;"><label for="iDate">Fecha:</label></div>
                  <div class="col-md-3">
