...
<body id="app-layout">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <?php
                    echo \Config::get('arcedu.arcedi_nameCompany');
                        ?>
                </a>
            </div>
    ...
    -->
    {{ HTML::script(asset('assets/bower/jquery/dist/jquery.js')) }}
    {{ HTML::script(asset('assets/bower/bootstrap/dist/js/bootstrap.js')) }}
